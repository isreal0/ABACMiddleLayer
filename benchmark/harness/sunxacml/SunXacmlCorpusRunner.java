...
public class SunXacmlCorpusRunner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length != 6) {
            ...
            System.err.println("   or: SunXacmlCorpusRunner benchmark <policyXml> <requestsDir> <manifestConf> <rawOutputTsv> <summaryOutputJson>");
            System.exit(2);
        }
    ...
    private static void runBenchmark(String policyXml, String requestsDir, String manifestConf,
                                      String rawOutputTsv, String summaryOutputJson) throws Exception {
        long[] policyLoadNsOut = new long[1];
        PDP pdp = buildPdp(policyXml, policyLoadNsOut);
        ...
        writeSummary(summaryOutputJson, "sunxacml", allLatencies, warmup, measured, repetitions);
        System.out.println("SunXACML benchmark: " + allLatencies.size() + " measured calls across "
    ...
    private static void writeSummary(String path, String engine, List<Long> latenciesNs,
                                      int warmup, int measured, int repetitions) throws Exception {
